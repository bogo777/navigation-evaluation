        	...
        	*/
            ...
            public class UT2004SharedObjectCreator {
				...
				public static interface ISharedObjectCreator<T extends ICompositeWorldObject>
				{
					...
					public static class LocationUpdateSharedCreator implements ISharedObjectCreator<LocationUpdate>
					{
						@Override
						public ISharedWorldObject create(WorldObjectId id, Collection<ISharedProperty> c) {
							return new LocationUpdateSharedImpl(id, c);
						}
					}
				...
				static {
						...
						map.put(
							LocationUpdate
							.class, 
							new LocationUpdateSharedCreator()
						);
