package cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages;
 	...
 	public abstract class Player   
    	...
    	public static final String PROTOTYPE =
    		"PLR {Id unreal_id}  {Jmx text}  {Name text}  {Action text}  {Visible False}  {Rotation 0,0,0}  {Location 0,0,0}  {Velocity 0,0,0}  {Team 0}  {Weapon text}  {Crouched False}  {Firing 0}  {EmotLeft text}  {EmotCenter text}  {EmotRight text}  {Bubble text}  {Anim text} ";
