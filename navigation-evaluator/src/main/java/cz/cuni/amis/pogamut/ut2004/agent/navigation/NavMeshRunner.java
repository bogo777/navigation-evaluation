...
/**
 * Playing with and modifying {@link KefikRunner} to test path following behaviour.
 * 
 * We assume that we work with path generated by NavMesh path planner. It should contain point on the nav mesh, 
 * which should be navigable by simple running, and off-mesh connections, which we will handle as original runner.
 * 
 *
 * @author Bogo
 */
