...
public class MyUT2004DistanceStuckDetector implements IStuckDetector {
	...
	public MyUT2004DistanceStuckDetector(UT2004Bot bot) {
		if (this.log == null) {
			...
			if (previousDistancing) {
				...
				if (distancingCount > 1) {
					if (log != null && log.isLoggable(Level.WARNING))
						log.warning("Bot stuck detected, #closing " + closingCount + ", #distancing " + distancingCount);
					stuck = true;
				}
			}
		}
