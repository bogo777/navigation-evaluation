...
public class JumpInspectingBot extends EvaluatingBot {
    ...
    double jumpDistance = 800;

    NavPoint startSpot = null;
    NavPoint endSpot = null;
    int step = 0;
...
//        }
    ...
    private boolean isOnTheGround(Location location) {
        return location.z <= zOnTheGround;
    }
}
