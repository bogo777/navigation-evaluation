...
public class NavigationEvaluatingBot extends EvaluatingBot {
	...
	public void botInitialized(GameInfo gameInfo, ConfigChange config, InitedMessage init) {
		...
		// return;
		// }
		// Self newSelf = new SelfMessage(self.getId(), self.getBotId(),
		// self.getName(), self.isVehicle(),
		// locationUpdate.getLoc(), locationUpdate.getVel(),
		// locationUpdate.getRot(), self.getTeam(),
		// self.getWeapon(), self.isShooting(), self.getHealth(),
		// self.getPrimaryAmmo(),
		// self.getSecondaryAmmo(), self.getAdrenaline(), self.getArmor(),
		// self.getSmallArmor(),
		// self.isAltFiring(), self.isCrouched(), self.isWalking(),
		// self.getFloorLocation(),
		// self.getFloorNormal(), self.getCombo(), self.getUDamageTime(),
		// self.getAction(),
		// self.getEmotLeft(), self.getEmotCenter(), self.getEmotRight(),
		// self.getBubble(),
		// self.getAnim());
