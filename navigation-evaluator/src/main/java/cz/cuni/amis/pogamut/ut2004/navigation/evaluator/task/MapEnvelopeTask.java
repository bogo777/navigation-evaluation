...
import cz.cuni.amis.pogamut.ut2004.navigation.evaluator.bot.MapEnvelopeBotParameters;
import java.io.File;
 ...
 * @author Bogo
 */
public class MapEnvelopeTask extends EvaluationTask<MapEnvelopeBotParameters, EnvelopeBot> implements IEvaluationTask<MapEnvelopeBotParameters, EnvelopeBot> {

    private String mapName;
    private String resultPath;

    private MapEnvelopeTask() {
        super(MapEnvelopeBotParameters.class, EnvelopeBot.class);
    }
    ...
    public MapEnvelopeBotParameters getBotParams() {
        return new MapEnvelopeBotParameters(this);
    }
